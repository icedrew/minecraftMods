...
public class Hammer extends Item implements IVanishable {
    ...
    public Hammer(Item.Properties p_i48788_1_) {
        super(p_i48788_1_);
        ...
        builder.put(Attributes.ATTACK_SPEED, new AttributeModifier(BASE_ATTACK_SPEED_UUID, "Tool modifier", (double) -9.9F, AttributeModifier.Operation.ADDITION));
