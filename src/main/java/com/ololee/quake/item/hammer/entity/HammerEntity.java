package com.ololee.quake.item.hammer.entity;
...
public class HammerEntity extends AbstractArrowEntity {
    ...
    public HammerEntity(EntityType<? extends HammerEntity> hammerEntityEntityType, World world) {
    ...
    public void readAdditionalSaveData(CompoundNBT p_70037_1_) {
        ...
        if (p_70037_1_.contains("Hammer", 10)) {
            this.tridentItem = ItemStack.of(p_70037_1_.getCompound("Hammer"));
        }
    ...
    public void addAdditionalSaveData(CompoundNBT p_213281_1_) {
        ...
        p_213281_1_.put("Hammer", this.tridentItem.save(new CompoundNBT()));
