package com.ololee.quake.item.hammer.render;
...
public class HammerRenderer extends EntityRenderer<HammerEntity> {
    ...
    public HammerRenderer(EntityRendererManager p_i48828_1_) {
        super(p_i48828_1_);
    }

    public void render(HammerEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
    ...
    public ResourceLocation getTextureLocation(HammerEntity p_110775_1_) {
